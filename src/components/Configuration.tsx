...
export function Configuration({ 
  ...
  // Automatically reset model to default when provider changes
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div>
              ...
              <select value={provider} onChange={handleProviderChange} className="w-full bg-white border border-black/20 rounded-lg px-3 py-2 text-black focus:outline-none focus:ring-2 focus:ring-black">
